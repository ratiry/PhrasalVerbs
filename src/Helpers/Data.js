...
export let phrasalVerbs=[
  ...
  {namw:"make up",description:["to invent something, such as an excuse or a story, often in order to deceive","to prepare or arrange something by putting different things together","to make an amount of something complete or correct"]},
  ...
  {name:"give out",description:["destribute","to complain about something","to make a piece of information public, especially information that is not true","when a machine or part of your body stops working","to last no longer, or to work no longer"]},
  ...
  {name:"come down with",description:["become ill from"]},
