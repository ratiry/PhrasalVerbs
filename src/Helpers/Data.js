...
export let phrasalVerbs=[
  ...
  {name:"let down",description:["to dissapoint someone","lengthen a garment (smth)"]},
  ...
  {name:"look over",description:["inspect quickly"]},
  ...
  {name:"put up",description:["to raise something, or to fix something in a raised position","to build something object in the middle","to increase the price or value of something","to provide or lend an amount of money for a particular purpose","to preserve food in glass or metal containers","to show or express a particular type of opposition to something","to suggest an idea","to make a person available","to be considered","to provide someone with a place to stay temporarily","to stay somewhere for the night","o show or express your feelings about something"]},
  {name:"bounce off",description:["to tell someone about an idea to find out what they think of it"]},
  {name:"bring out",description:["to make shy person more confident","to produce smth for public","to make detail noticable"]},
  ...
  {name:"back down",description:["admit that you were wrong"]},
  ...
  {name:"fill in",description:["to give someone extra or missing information object in the middle","to do someone else's work for them because they cannot or will not do it themselves or to do it temporily","to write or type information on a document in spaces that are provided for it"]},
  ...
  {name:"bring forward",description:["suggest an indea"]},
  ...
  {name:"come across",description:["meet by chance"]},
  ...
  {name:"fall on",description:["attack","eat food hungrily"]},
  {name:"get about",description:["move about","spread"],synonyms:["get round"]},
  {name:"get at",description:["reach","critisize","When someone is ___ something, they mean it or are trying to express it","to influence a person illegally, usually by offering them money or threatening them"]},
  {name:"get away from",description:["escape","leave"]},
  ...
  {name:"give away",description:["give sth for free","reveal"]},
  ...
  {name:"hold back",description:["hesitate","control","keep a secret"],synonyms:["keep back","keep down"]},
  {name:"hold out",description:["endure","last"]},
  {name:"keep away",description:["stay away from smth"]},
  {name:"keep down",description:["control (object in the middle)"],synonyms:["hold back"]},
  ...
  {name:"let on",description:["reveal a secret"]},
