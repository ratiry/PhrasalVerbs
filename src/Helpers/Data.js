...
export let phrasalVerbs=[
  ...
  {name:"look over",description:["to quickly examine something"]},
  ...
  {name:"come across",description:["meet by chance"],synonyms:["run into"]},
  ...
  {name:"do down",description:["speak badly of smb"],synonyms:["put down"]},
  ...
  {name:"set about",description:["to attack someone","to start to do or deal with something"]},
  ...
  {name:"look through",description:["to read something quickly"]},
  {name:"put aside",description:["save money"]},
  {name:"put down",description:["suppress by force","write down","attribute to","critisize"],synonyms:["do down"]},
  ...
  {name:"run into",description:["meet unepectantly"],synonyms:["come across"]},
