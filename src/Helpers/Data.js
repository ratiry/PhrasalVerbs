...
export let phrasalVerbs=[
  ...
  {name:"set off",description:["cause a series of events","to cause a loud noise/explosion(bomb/alarm)","start a journey"],synonyms:["set out"]},
  ...
  {name:"fall on",description:["attack","eat food hungrily"],synonyms:["set on"]},
  ...
  {name:"set about",description:["begin to do","attack"]},
  ...
  {name:"set on",description:["(cause to) attack"],synonyms:["fall on"]},
