...
export let phrasalVerbs=[
  ...
  {name:"put up",description:["to raise something, or to fix something in a raised position","to build something object in the middle","to increase the price or value of something","to provide or lend an amount of money for a particular purpose","to preserve food in glass or metal containers","to show or express a particular type of opposition to something","to suggest an idea","to make a person available","to be considered","to provide someone with a place to stay temporarily","to stay somewhere for the night","to show or express your feelings about something (negative ones)"],synonyms:["bring forward"]},
  ...
  {name:"bring forward",description:["suggest an indea"],synonyms:["put up"]},
  ...
  {name:"keep down",description:["to prevent a person or group of people from having any power or freedom object in the middle","to control the size or number of something and prevent it from increasing","to be able to eat or drink something without vomiting:"],synonyms:["hold back"]},
