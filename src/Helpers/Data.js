...
const ddata={
  phrasalVerbs:{
    ...
    contents:[
      ...
      {name:"talk through",description:["to discuss the details of smth before making decision"],synonyms:["talk over"]},
      ...
      {name:"frown on",description:["have a bad opinion about something"]},
      {name:"know of",description:["know something/someone that it exists , but not personally"],synonyms:["hear of"]},
      ...
      {name:"buy out",description:["to acquire a final share of something object in the middle"]},
      ...
      {name:"rent out",description:["give sb place to live for pay"]},
      {name:"work over",description:["hurt sb physically or mentally"]},
      {name:"take out on",description:["express negative emotions on sb"]},
      {name:"fall under",description:["be categorized"," become being under sb's control"]},
      {name:"chicken out",description:["choose not to be brave"],synonyms:["puss out","wuss out"]},
      {name:"wither away",description:["start to disappear"]},
      {name:"pitch in",description:["help","contribute part for common interest"]},
      {name:"make up to",description:["return debt( for service) not with money (object in the middle)"]},
      {name:"hear of",description:["know something/someone that it exists , but not personally"],synonyms:["know of"]},
      {name:"root for",description:["want something to win"]},
      {name:"move in on",description:["put oneself to attack"]},
      {name:"get in on",description:["participate in something willingfully"]},
      {name:"egg on",description:["push somebody to stressfull situation","push somebody to do something"]},
      {name:"run along",description:["go away"]},
      {name:"hang out",description:["go frequently somewhere"]},
      {name:"hang around",description:["spend time doing nothing important"]},
      {name:"fall behind",description:["not to keep up"]},
      {name:"rinse off",description:["wash a little bit"]},
      {name:"zone out",description:["lose concentration"]},
      {name:"back up",description:["save in different location (computer)","support someone"]},
      {name:"talk over",description:["discuss"],synonyms:["talk through"]},
      {name:"wind up",description:["make someone or something excited"]},
      {name:"wind down",description:["relax"]},
      {name:"die out",description:["completly die"]},
      {name:"kill off",description:["kill the last one"]},
      {name:"catch up",description:["reach someone in front of you by going faster than them:"]},
      {name:"flip off",description:["show middle finger"]},
      {name:"close off",description:["isolate and prevent from using it"]},
      {name:"close down",description:["make smth stop operating"]},
      {name:"knock down",description:["demolish","hit and cause to fall"],synonyms:["tear down"]},
      {name:"drop off",description:["leave somewhere"]},
      {name:"clean up",description:["clean throughlly"]}
    ]
  },
  idioms:{
    name:"idioms",
    ...
    contents:[
      ...
      {name:"an apple of ones eye",description:["someone who is cherished above all others"]},
      ...
      {name:"give the bird",description:["show the middle finger"]},
    ],
  },
  prepositions:{
    name:"prepositions",
    picture404:"https://i.pinimg.com/474x/80/f4/d1/80f4d1146d9758937256e467ce0df7fe.jpg",
    contents:[
      {name:"good at",description:["good _ (proficiency)"],answer:"at",type:"adjective"},
      {name:"for hire/rent",description:[" _ hire/rent"],answer:"for",type:"phrase"},
      {name:"at least",description:["_ least"],answer:"at",type:"phrase"},
      {name:"in the first place",description:["_ the first place"],answer:"in",type:"phrase"},
      {name:"on schedule",description:["_ schedule"],answer:"on",type:"phrase"},
      {name:"on the move",description:["_ the move"],answer:"on",type:"phrase"},
      {name:"for sure/certain",description:["_ certain/sure"],answer:"for",type:"phrase"},
      {name:"by post/air mail",description:["_ post/air mail"],answer:"by",type:"phrase"},
      {name:"on an excursion",description:["_ an excursion"],answer:"on",type:"phrase"},
      {name:"by accident",description:["_  accident"],answer:"by",type:"phrase",},
      {name:"in other words",description:["_ other words"],answer:"in",type:"phrase"},
      {name:"at once",description:["_ once"],answer:"at",type:"phrase"},
      {name:"on board",description:["_ board"],answer:"on",type:"phrase"},
      {name:"in short",description:["_ short"],answer:"in",type:"phrase"},
      {name:"on trip/tour",description:["_ trip/tour"],answer:"on",type:"phrase"},
      {name:"regardless of",description:["regardless _"],answer:"of",type:"phrase"},
      {name:"due to",description:["due _"],answer:"to",type:"phrase"},
      {name:"except for",description:["except _"],answer:"for",type:"phrase"},
      {name:"according to",description:["according _"], answer:"to",type:"phrase"},
      {name:"because of",description:["because _"],answer:"of",type:"phrase"},
      {name:"apart from",description:["apart _"],answer:"from",type:"phrase"},
      {name:"owing to",description:["owing _"],answer:"to",type:"phrase"},
      {name:"instead of",description:["instead _"],answer:"of",type:"phrase"},
      {name:"thanks to",description:["thanks _"],answer:"to",type:"phrase"},
      {name:"but for",description:["but _ (used in conditionals)"],answer:"for",type:"phrase"},
      {name:"contrary to",description:["contrary _"],answer:"to",type:"phrase"},
      {name:"as for",description:["as _"],answer:"for",type:"phrase"},
      {name:"in spite of",description:["_ spite _"],answer:"inof",type:"phrase"},
      {name:"in comparison to",description:["_ comparison _",],answer:"into",type:"phrase"},
      {name:"in favour of",description:["_ favour _ something"],answer:"inof",type:"phrase"},
      {name:"in charge of",description:["_ charge _"],answer:"inof",type:"phrase"},
      {name:"in control of",description:["_ control _"],answer:"inof",type:"phrase"},
      {name:"on behalf of",description:["_ behalf _"],answer:"onof",type:"phrase"},
      {name:"as far as",description:["_ far _"],answer:"asas",type:"phrase"},
      {name:"in honour of",description:[ "_ honour _"],answer:"inof",type:"phrase"},
      {name:"as well as",description:[ "_  well _ "],answer:"asas",type:"phrase"},
      {name:"to somebody's suprise",description:["_ somebody's suprise"],answer:"to",type:"phrase"},
      {name:"ashamed of",description:["ashamed _ something"],answer:"of",type:"adjective"},
      {name:"busy with",description:["busy _ something"],answer:"with",type:"adjective"},
      {name:"jealous of",description:["jealous _ somebody"],answer:"of",type:"adjective"},
      {name:"useful to somebody",description:["useful _ somebody"],answer:"to",type:"adjective"},
      {name:"useful for something",description:["useful _ something"],answer:"for",type:"adjective"},
      {name:"an exception to",description:["an exception _ a rule"],answer:"to",type:"noun"},
      {name:"comment on",description:["comment _ something"],answer:"on",type:"verb"},
      {name:"decide on",description:["decide _ something"],answer:"on",type:"verb"},
      {name:"under arrest",description:["be _ arrest"],answer:"under",type:"phrase"},
      {name:"on second thoughts",description:["_ second thoughts"],answer:"on",type:"phrase"},
      {name:"in the long run",description:["_ the long run"],answer:"in",type:"phrase"},
      {name:"in one's opinion",description:["_ one's opinion"],answer:"in",type:"phrase"},
      {name:"in reality",description:["_ reality he turned out to be ...."],answer:"in",type:"phrase"},
      {name:"on a diet",description:["I'm  _ a diet"],answer:"on",type:"phrase"},
      {name:"in a mess",description:["your room is _ a mess"],answer:"in",type:"phrase"},
      {name:"on fire",description:["housse is _ fire"],answer:"on",type:"phrase"},
      {name:"by mistake",description:["_ mistake"],answer:"by",type:"phrase"},
      {name:"in general",description:["_ general"],answer:"in",type:"phrase"},
      {name:"on the radio",description:["_ the radio"],answer:"on",type:"phrase"},
      {name:"at all costs",description:["_ all costs"],answer:"at",type:"phrase"},
      {name:"on average",description:["_ average"],answer:"on",type:"phrase"},
      {name:"on demand",description:["_ demand"],answer:"on",type:"phrase"},
      {name:"on the whole",description:["_ the whole"],answer:"on",type:"phrase"},
      {name:"in half",description:["chop _ half"],answer:"in",type:"phrase"},
      {name:"on strike",description:["_ strike"],answer:"on",type:"phrase"},
      {name:"in pairs",description:["_ pairs"],answer:"in",type:"phrase"},
      {name:"in person",description:["talk _ person"],answer:"in",type:"phrase"},
      {name:"in memory of",description:["_ memory _"],answer:"inof",type:"phrase"},
      {name:"on credit",description:["shop _ credit"],answer:"on",type:"phrase"},
      {name:"by all accounts",description:["_ all accounts"],answer:"by",type:"phrase"},
      {name:"for sale",description:["be up _ sale"],answer:"for",type:"phrase"},
      {name:"complain of",description:["complain _ something"],answer:"of",type:"verb"},
      {name:"critisize for",description:["critisize someone _ something"],answer:"for",type:"verb"},
      {name:"discourage from",description:["decourage someone _ doing something"],answer:"from",type:"verb"},
      {name:"at great cost",description:["_ great cost"],answer:"at",type:"phrase"},
      {name:"agree on",description:["agree _ action"],answer:"on",type:"verb"},
      {name:"demand from",description:["demand _ someone or something"],answer:"from",type:"verb"},
      ...
      {name:"patient with",description:["patient _ something or somebody"],answer:"with",type:"verb"},
