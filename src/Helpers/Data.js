...
const ddata={
  ...
  prepositions:{
    ...
    contents:[
      ...
      {name:"for hire/rent",description:[" _ hire/rent"],answer:"for"},
      {name:"at least",description:["_ least"],answer:"at"},
      {name:"in the first place",description:["_ the first place"],answer:"in"},
      {name:"on schedule",description:["_ schedule"],answer:"on"},
      {name:"on the move",description:["_ the move"],answer:"on"},
      {name:"for sure/certain",description:["_ certain/sure"],answer:"for"},
      {name:"by post/air mail",description:["_ post/air mail"],answer:"by"},
      {name:"on an excursion",description:["_ an excursion"],answer:"on"},
      {name:"by accident",description:["_  accident"],answer:"by"},
      {name:"in other words",description:["_ other words"],answer:"in"},
      {name:"at once",description:["_ once"],answer:"at"},
      {name:"on board",description:["_ board"],answer:"on"},
      {name:"in short",description:["_ short"],answer:"in"},
      {name:"on trip/tour",description:["_ trip/tour"],answer:"on"},
      {name:"regardless of",description:["regardless _"],answer:"of"},
      {name:"due to",description:["due _"],answer:"to"},
      {name:"except for",description:["except _"],answer:"for"},
      {name:"according to",description:["according _"], answer:"to"},
      {name:"because of",description:["because _"],answer:"of"},
      {name:"apart from",description:["apart _"],answer:"from"},
      {name:"owing to",description:["owing _"],answer:"to"},
      {name:"instead of",description:["instead _"],answer:"of"},
      {name:"thanks to",description:["thanks _"],answer:"to"},
      {name:"but for",description:["but _ (used in conditionals)"],answer:"for"},
      {name:"contrary to",description:["contrary _"],answer:"to"},
      {name:"as for",description:["as _"],answer:"for"},
      {name:"in spite of",description:["_ spite _"],answer:"inof"},
      {name:"in comparison to",description:["_ comparison _",],answer:"into"},
      {name:"in favour of",description:["_ favour _ something"],answer:"inof"},
      {name:"in charge of",description:["_ charge _"],answer:"inof"},
      {name:"in control of",description:["_ control _"],answer:"inof"},
      {name:"on behalf of",description:["_ behalf _"],answer:"onof"},
      {name:"as far as",description:["_ far _"],answer:"asas"},
      {name:"in honour of",description:[ "_ honour _"],answer:"inof"},
      {name:"as well as",description:[ "_  well _ "],answer:"asas"},
      {name:"to somebody's suprise",description:["_ somebody's suprise"],answer:"to"},
    ]
  }
}
