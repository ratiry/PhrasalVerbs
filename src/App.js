...
function App() {
  ...
  useEffect(() => {
    if (location.hash != "") {
      if (
        location.pathname == Urls.mistakes ||
        Urls.collection == location.pathname
      ) {
        ...
        location.pathname == Urls.collections ||
        Urls.verbs == location.pathname
      ) {
